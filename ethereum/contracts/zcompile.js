...
const fileList = ['SafeMath', 'Ownable', 'AssetBook', 'Registry', 'HCAT721_AssetToken', 'TokenController', 'CrowdFunding', 'IncomeManagerCtrt', 'ProductManager', 'Helium', 'Settlement'];//'Test1' HCAT721_Test
/**
