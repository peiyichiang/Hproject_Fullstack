...
//接收上傳圖片請求的接口
var cpUpload = upload.fields([{ name: 'p_NotarizedRentalContract_Mask_form', maxCount: 1 },{ name: 'p_OnGridAuditedLetter_Mask_form', maxCount: 1 },{ name: 'p_BOEApprovedLetter_Mask_form', maxCount: 1 },{ name: 'p_powerPurchaseAgreement_Mask_form', maxCount: 1 },{ name: 'p_onGridTryrunLetter_Mask_form', maxCount: 1 },{ name: 'p_powerPlantEquipmentRegisteredLetter_Mask_form', maxCount: 1 },{ name: 'p_powerPlantInsurancePolicy_Mask_form', maxCount: 1 },{ name: 'p_NotarizedRentalContract_form', maxCount: 1 },{ name: 'p_OnGridAuditedLetter_form', maxCount: 1 },{ name: 'p_BOEApprovedLetter_form', maxCount: 1 },{ name: 'p_powerPurchaseAgreement_form', maxCount: 1 },{ name: 'p_onGridTryrunLetter_form', maxCount: 1 },{ name: 'p_powerPlantEquipmentRegisteredLetter_form', maxCount: 1 },{ name: 'p_powerPlantInsurancePolicy_form', maxCount: 1 }, { name: 'icon', maxCount: 1 }, { name: 'csvFIle', maxCount: 1 }, { name: 'image1', maxCount: 1 }, { name: 'image2', maxCount: 1 }, { name: 'image3', maxCount: 1 }, { name: 'image4', maxCount: 1 }, { name: 'image5', maxCount: 1 }, { name: 'image6', maxCount: 1 }, { name: 'image7', maxCount: 1 }, { name: 'image8', maxCount: 1 }, { name: 'image9', maxCount: 1 }, { name: 'image10', maxCount: 1 },{ name: 'image11', maxCount: 1 }])
