...
//接收上傳圖片請求的接口
var cpUpload = upload.fields([{ name: 'p_NotarizedRentalContract_form', maxCount: 1 },{ name: 'p_ParallelAuditedLetter_form', maxCount: 1 }, { name: 'icon', maxCount: 1 }, { name: 'csvFIle', maxCount: 1 }, { name: 'image1', maxCount: 1 }, { name: 'image2', maxCount: 1 }, { name: 'image3', maxCount: 1 }, { name: 'image4', maxCount: 1 }, { name: 'image5', maxCount: 1 }, { name: 'image6', maxCount: 1 }, { name: 'image7', maxCount: 1 }, { name: 'image8', maxCount: 1 }, { name: 'image9', maxCount: 1 }, { name: 'image10', maxCount: 1 }])
