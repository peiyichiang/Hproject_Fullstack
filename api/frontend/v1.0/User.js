...
router.post('/send_email', function (req, res) {
    ...
    let mailOptions = {
        ...
        html: `<p>請點以下連結以完成驗證： <a href="${process.env.SERVER_PROTOCOL}://hcat.io:${process.env.SERVER_PORT}/frontendAPI/v1.0/User/verify_email?hash=${passwordHash}">點我完成驗證</a>` // html body
    };
